...
getLabelClass = $('.form-group');
clickInput = $('#input-coffee');
...
getLabelClass.children().eq(1).on('click', function () {
    $(this).css("background-color", "#ffc107");
    getLabelClass.children().eq(2).css("background-color", "#fff");
    getLabelClass.children().eq(3).css("background-color", "#fff");
    document.getElementById("input-coffee").value = document.getElementById('first').innerHTML;
});

getLabelClass.children().eq(2).on('click', function () {
    $(this).css("background-color", "#ffc107");
    getLabelClass.children().eq(1).css("background-color", "#fff");
    getLabelClass.children().eq(3).css("background-color", "#fff");
    document.getElementById("input-coffee").value = document.getElementById('second').innerHTML;
});

getLabelClass.children().eq(3).on('click', function () {
    $(this).css("background-color", "#ffc107");
    getLabelClass.children().eq(1).css("background-color", "#fff");
    getLabelClass.children().eq(2).css("background-color", "#fff");
    document.getElementById("input-coffee").value = document.getElementById('third').innerHTML;
});
